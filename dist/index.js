...
exports.getPublicClientUserList = exports.getClientList = exports.getLeaderboard = exports.ClientCardSM = exports.ClientCardLG = exports.UserList = exports.ClientList = exports.Leaderboard = void 0;
// index.ts
const axios_1 = __importDefault(require("axios"));
// Exporting types and components for external usage
__exportStar(require("./types"), exports);
var components_1 = require("./components");
Object.defineProperty(exports, "Leaderboard", { enumerable: true, get: function () { return components_1.Leaderboard; } });
Object.defineProperty(exports, "ClientList", { enumerable: true, get: function () { return components_1.ClientList; } });
Object.defineProperty(exports, "UserList", { enumerable: true, get: function () { return components_1.UserList; } });
Object.defineProperty(exports, "ClientCardLG", { enumerable: true, get: function () { return components_1.ClientCardLG; } });
Object.defineProperty(exports, "ClientCardSM", { enumerable: true, get: function () { return components_1.ClientCardSM; } });
/**
 * Base URLs for the API endpoints.
 * @constant
 */
const BASE_URL = "https://tribe-api-wrapper.bankkroll.repl.co/leaderboard-ranking?";
...
const getLeaderboard = async (client, options) => {
    ...
    const url = client.toLowerCase() === "all"
        ? `${BASE_URL}trial=${trial}&badge_filter=${badgeFilter}&time_period=${encodeURIComponent(timePeriod)}`
        : `${BASE_URL}client=${encodeURIComponent(client)}&trial=${trial}&badge_filter=${badgeFilter}&time_period=${encodeURIComponent(timePeriod)}`;
    try {
